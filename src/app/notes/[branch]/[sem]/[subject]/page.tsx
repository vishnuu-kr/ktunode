...
export async function generateMetadata({ params, searchParams }: PageProps): Promise<Metadata> {
  ...
  let canonicalUrl = `${SITE_URL}/${branch}/sem-${semNum}/${subjectIdOrCode.toLowerCase()}`;
  ...
  if (topicId && subject) {
    ...
    if (topic) {
      ...
      canonicalUrl = `${SITE_URL}/${branch}/sem-${semNum}/${subjectIdOrCode.toLowerCase()}/${topicId.toLowerCase()}`;
    }
  }
