...
import { 
  ...
  CheckSquare, Dices, Map, Globe, Binary, Split, FlaskConical, LayoutGrid, ArrowUpRight
} from "lucide-react";
  ...
  return (
    <div className="space-y-6 w-full relative">
      ...
      <div className="bg-slate-50/50 dark:bg-slate-900/40 border border-slate-200/50 dark:border-white/[0.04] p-3 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm backdrop-blur-xl font-sans">
        ...
        <div className="flex items-center gap-1 bg-slate-100/80 dark:bg-slate-900/60 p-1 rounded-xl border border-slate-200 dark:border-slate-800/80 overflow-x-auto scrollbar-none py-1.5 relative w-full md:w-auto">
          {categories.map(cat => {
            ...
            return (
              ...
              >
                <div className="relative z-10 flex flex-col justify-between h-full w-full">
                  <div>
                    {/* Top Row: Icon Container, Title, and Category Badge */}
                    ...
                    {/* Description */}
                    <p className="text-[11.5px] text-slate-500 dark:text-slate-400 font-medium leading-normal mt-3 line-clamp-2">
                      {tool.desc}
                    </p>
                  </div>
